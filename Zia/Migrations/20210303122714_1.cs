        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dicount = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    coupinDiscount = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoUploaderId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Categories_VideoUploaders_VideoUploaderId",
                        column: x => x.VideoUploaderId,
                        principalTable: "VideoUploaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    img = table.Column<string>(nullable: true),
                    type = table.Column<string>(nullable: true),
                    publicPrice = table.Column<double>(nullable: false),
                    priceAfterDisCont = table.Column<double>(nullable: false),
                    isActive = table.Column<bool>(nullable: false),
                    shortDis = table.Column<string>(nullable: true),
                    size = table.Column<string>(nullable: true),
                    LongDis = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_VideoUploaderId",
                table: "Categories",
                column: "VideoUploaderId");
