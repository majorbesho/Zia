...
namespace Zia.Migrations
{
    ...
    [Migration("20210303222422_addArItem")]
    partial class addArItem
    {
            ...
            modelBuilder.Entity("Zia.Models.Category", b =>
                {
                    ...
                    b.Property<int>("VideoUploaderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VideoUploaderId");

                    b.ToTable("Categories");
                });

            modelBuilder.Entity("Zia.Models.Clinet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Zia.Models.Item", b =>
                {
                    ...
                    b.Property<string>("ArSpecifications")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Zia.Models.Category", b =>
                {
                    ...
                    b.HasOne("Zia.Models.VideoUploader", "VideoUploader")
                        .WithMany()
                        .HasForeignKey("VideoUploaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
